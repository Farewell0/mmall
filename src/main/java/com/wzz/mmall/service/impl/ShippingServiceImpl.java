...
import com.wzz.mmall.dao.ShippingMapper;
import com.wzz.mmall.pojo.Shipping;
import com.wzz.mmall.service.IShippingService;
...
//      int rowCount = shippingMapper.deleteByPrimaryKey(shippingId);// 为防止横向越权，不能用这个方法
